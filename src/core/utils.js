...
export function uid(prefix = '') {
  return `${prefix}${++_uidCounter}_${Date.now().toString(36)}`;
}
...
export function formatDate(day, season, year) {
  return `Y${year} · 第${day}天`;
}

// ===== 动画工具 =====
export function animateValue(el, from, to, duration = 400) {
...
export function lucideIcon(name, size = 20, strokeWidth = 1.5, extraClass = '') {
  const key = `${name}-${size}-${strokeWidth}`;
  if (ICON_CACHE.has(key)) return ICON_CACHE.get(key).cloneNode(true);

  // We use inline SVG paths for the most common icons
  ...
  ICON_CACHE.set(key, svg.cloneNode(true));
  return svg;
}

// Inline SVG path data for commonly used Lucide icons
export const ICON_PATHS = {
  ...
  'sprout': '<path d="M7 20h10"/><path d="M10 20c5.5-2.5.8-6.4 3-10"/><path d="M9.5 9.4c1.1.8 1.8 2.2 2.3 3.7-2 .4-3.5.4-4.8-.3-1.2-.6-2.3-1.9-3-4.2 2.8-.5 4.4 0 5.5.8z"/><path d="M14.5 13.5c3.6 1 6.5-1.5 6.5-1.5s-1.5-2-5.5-1.5"/>',
  ...
  'telescope': '<path d="m10.065 12.493-6.18 1.318a.934.934 0 0 1-1.108-.702l-.537-2.15a1.07 1.07 0 0 1 .691-1.265l13.504-4.44"/><path d="m13.56 11.747 4.332-.924"/><path d="m16 21-3.105-6.21"/><path d="M16.485 5.94a2 2 0 0 1 1.455-2.425l1.09-.272a1 1 0 0 1 1.212.727l1.515 6.06a1 1 0 0 1-.727 1.213l-1.09.272a2 2 0 0 1-2.425-1.455z"/><path d="m6.158 8.633 1.114 4.456"/>',
  ...
  'monitor-play': '<rect x="2" y="3" width="20" height="14" rx="2"/><path d="M10 9l5 3-5 3z"/><path d="M12 17v4"/><path d="M8 21h8"/>',
  ...
  'leaf': '<path d="M11 20A7 7 0 0 1 9.8 6.9C15.5 4.9 20 7.4 20 7.4S22.5 12 20.5 17.7A7 7 0 0 1 11 20Z"/><path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12"/>',
  ...
  'trees': '<path d="M10 10v.2A3 3 0 0 1 8.9 16v0H5v0h0a3 3 0 0 1-1-5.8V10a3 3 0 0 1 6 0Z"/><path d="M7 16v6"/><path d="M13 19v3"/><path d="M15.7 14a5 5 0 0 0-3.3-8.8A4.5 4.5 0 0 0 4 8"/><path d="M20 10a3 3 0 0 1 0 6H18a3 3 0 0 1-6 0c0-.7.2-1.2.5-1.7"/><path d="M13 19h7"/>',
  ...
  'flask-round': '<path d="M10 2v7.527a2 2 0 0 1-.211.896L4.72 20.55a1 1 0 0 0 .9 1.45h12.76a1 1 0 0 0 .9-1.45l-5.069-10.127A2 2 0 0 1 14 9.527V2"/><path d="M8.5 2h7"/>',
  'gallery-vertical-end': '<path d="M7 2h10"/><path d="M5 6h14"/><rect x="3" y="10" width="18" height="12" rx="2"/>',
  ...
  'tent': '<path d="M19 20 10 4"/><path d="m5 20 9-16"/><path d="M2 20h20"/><path d="m7 20 5-10 5 10"/>',
