...
export const SPECIES = [
  {
    ...
    tiers: [
      { level: 20, name: '初次接触', reward: '解锁建筑图纸：星际博物馆', rewardBlueprint: 'museum' },
      { level: 50, name: '文化交流', reward: '解锁科技：殖民文化学', rewardTech: 'culture_1' },
      { level: 80, name: '深层共鸣', reward: '解锁建筑图纸：星穹音乐厅', rewardBlueprint: 'concert_hall' },
    ],
  ...
  },
  {
    ...
    tiers: [
      { level: 25, name: '频率校准', reward: '解锁科技：深空天文学', rewardTech: 'astronomy' },
      { level: 55, name: '知识共享', reward: '研究速度+20%' },
      { level: 85, name: '意识融合', reward: '解锁建筑图纸：量子计算中心', rewardBlueprint: 'quantum_lab' },
    ],
  ...
  },
  {
    ...
    tiers: [
      { level: 20, name: '协议建立', reward: '解锁建筑图纸：深空雷达', rewardBlueprint: 'radar' },
      { level: 50, name: '技术互换', reward: '建造速度+15%' },
      { level: 80, name: '联盟协定', reward: '解锁科技：能量护盾', rewardTech: 'shields' },
    ],
  ...
  },
  {
    ...
    tiers: [
      { level: 15, name: '根系触碰', reward: '解锁建筑图纸：生态温室', rewardBlueprint: 'greenhouse' },
      { level: 45, name: '共生关系', reward: '农场产出+25%' },
      { level: 75, name: '网络融合', reward: '解锁科技：生态工程', rewardTech: 'ecology' },
    ],
