...
export const TECHS = [
  ...
  },
  {
    ...
    cost: { research: 20 },
    prereqs: [],
    unlocks: ['museum', 'restaurant'],
    gravity: { culture: 3, comfort: 1 },
    position: { x: 700, y: 60 },
  },
  {
    id: 'recruitment_protocol',
    name: '星际招募协议',
    tier: 1,
    icon: 'users',
    desc: '建立向全银河系发布人才招募与移民面试的标准化流程。',
    flavor: '浩瀚星海中，总有怀揣梦想的探索者在寻找归宿。',
    cost: { research: 25 },
    prereqs: [],
    unlocks: ['immigration_center'],
    gravity: { comfort: 2, culture: 2, knowledge: 1 },
    position: { x: 400, y: 30 },
  },
  ...
  },
  {
    ...
    cost: { research: 50 },
    prereqs: ['culture_1'],
    unlocks: ['concert_hall', 'monument', 'amusement_park'],
    gravity: { culture: 5, comfort: 2 },
    position: { x: 700, y: 240 },
  },
  {
    id: 'scenic_engineering',
    name: '星际生态观光学',
    tier: 2,
    icon: 'ferris-wheel',
    desc: '结合生态地质与旅游景观规划，建造标志性的人造星际地标。',
    flavor: '让整个银河都为我们的风景驻足。',
    cost: { research: 45 },
    prereqs: ['culture_1', 'biotech_1'],
    unlocks: ['holo_wheel', 'bio_tower', 'float_fountain'],
    gravity: { culture: 4, nature: 3, comfort: 2 },
    position: { x: 800, y: 160 },
  },

  // Tier 3
  {
    id: 'precision_synthesis',
    name: '量子精密加工',
    tier: 3,
    icon: 'cpu',
    desc: '突破微观粒子束控技术，解锁二级深度加工设施【量子精密合成仪】。',
    flavor: '将每一个原子，精准码放在它该在的位置。',
    cost: { research: 65 },
    prereqs: ['sensors'],
    unlocks: ['quantum_assembler'],
  ...
  // Tier 4
  {
    id: 'miracle_foundry_tech',
    name: '宏观奇迹铸造',
    tier: 4,
    icon: 'sparkles',
    desc: '融合星能与超导矩阵，解锁三级终极加工设施【奇迹铸造厂】。',
    flavor: '在这座铸造厂中诞生的，是改写文明进程的奇迹。',
    cost: { research: 90 },
    prereqs: ['quantum', 'precision_synthesis'],
    unlocks: ['miracle_foundry'],
    gravity: { knowledge: 6, culture: 3 },
